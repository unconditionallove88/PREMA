...
const styles = StyleSheet.create({
  ...
  timerLabel: { fontSize: 10, fontFamily: "Inter_700Bold", letterSpacing: 2 },
  timerValue: { fontSize: 44, fontFamily: "Inter_700Bold", letterSpacing: -1 },
  timerMeta: { fontSize: 13, fontFamily: "Inter_600SemiBold" },
  timerNone: { fontSize: 16, fontFamily: "Inter_500Medium", fontStyle: "italic", marginTop: 4 },
  mixingBtn: {
    flexDirection: "row",
    alignItems: "center",
    gap: 14,
  ...
  mixingTitle: { fontSize: 15, fontFamily: "Inter_700Bold" },
  mixingSub: { fontSize: 11, fontFamily: "Inter_500Medium", marginTop: 2 },
  composer: { borderRadius: 24, borderWidth: 1, padding: 20, gap: 16, marginBottom: 24 },
  composerTitle: { fontSize: 15, fontFamily: "Inter_700Bold" },
  ...
  addBtnText: { fontSize: 14, fontFamily: "Inter_700Bold", letterSpacing: 1, textTransform: "uppercase" },
  historyHeader: {
    flexDirection: "row",
    alignItems: "center",
  ...
  historyTitle: { fontSize: 10, fontFamily: "Inter_700Bold", letterSpacing: 2 },
  clearText: { fontSize: 11, fontFamily: "Inter_600SemiBold", textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  itemTime: { fontSize: 11, fontFamily: "Inter_500Medium", marginTop: 3 },
  ...
  modalIntro: { fontSize: 13, fontFamily: "Inter_500Medium", lineHeight: 20, marginBottom: 18 },
  ...
  comboTitle: { fontSize: 14, fontFamily: "Inter_700Bold", flex: 1 },
  riskTag: { paddingVertical: 4, paddingHorizontal: 10, borderRadius: 999 },
  riskText: { fontSize: 10, fontFamily: "Inter_700Bold", letterSpacing: 0.5, textTransform: "uppercase" },
  comboItems: { fontSize: 11, fontFamily: "Inter_600SemiBold", letterSpacing: 0.3 },
  comboNote: { fontSize: 13, fontFamily: "Inter_500Medium", lineHeight: 20 },
  principlesTitle: { fontSize: 11, fontFamily: "Inter_700Bold", letterSpacing: 2, marginTop: 10, marginBottom: 12 },
  principleRow: { flexDirection: "row", alignItems: "flex-start", gap: 10, marginBottom: 10 },
  principleText: { flex: 1, fontSize: 13, fontFamily: "Inter_500Medium", lineHeight: 20 },
  closeBtn: {
    height: 52,
    borderRadius: 999,
    borderWidth: 1,
  ...
  closeBtnText: { fontSize: 14, fontFamily: "Inter_700Bold", letterSpacing: 1, textTransform: "uppercase" },
});
