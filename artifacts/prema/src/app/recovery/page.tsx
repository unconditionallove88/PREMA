...
const CONTENT = {
  ...
  de: {
    ...
    protocolGenerated: "Persönliches Protokoll erstellt ", 
    ...
    mentalDesc: "Begleitung bei Paranoia oder intensiven Nebenwirkungen  hier",
...
export default function RecoveryView() {
  ...
  useEffect(() => {
    const plan: any[] = [
      { id: 'ritual', time: "Immediate", text: t.ritualTitle, desc: t.ritualDesc, icon: Wind, color: "text-primary", action: () => setLocation('/self-care') },
    ...
    setDetoxPlan(plan);
  }, [lang, t.ritualTitle, t.ritualDesc, t.mentalTitle, t.mentalDesc, t.gpTitle, t.gpDesc]);
    ...
    <main className="min-h-screen bg-card text-white font-headline pb-64 pt-safe">
      <div className="bg-card/95 backdrop-blur-xl border-b border-border/5 px-6 py-8 sticky top-0 z-50">
        <div className="max-w-xl mx-auto space-y-6">
          <button onClick={() => window.history.back()} className="flex items-center gap-2 text-white/40 uppercase font-black text-[10px] tracking-widest hover:text-primary transition-colors"><ArrowLeft className="w-4 h-4" /> Back to home</button>
