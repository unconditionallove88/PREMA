...
const PHASE_META: Record<Phase, {
  ...
  before: {
    ...
    borderIdle: 'border-pink-400/20',
    bgActive: 'bg-pink-400/10',
    cardBg: 'bg-pink-400/5 border-pink-400/30',
    cardBtn: 'bg-pink-500 text-white hover:bg-pink-500/90',
    path: '/before',
  },
  during: {
    ...
    cardBtn: 'bg-accent text-accent-foreground hover:bg-accent/90',
    path: '/dashboard',
  },
  after: {
    icon: <Moon size={22} />,
    ...
    cardBtn: 'bg-purple-500 text-white hover:bg-purple-500/90',
    path: '/recovery',
  },
};
