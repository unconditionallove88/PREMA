  ...
  return (
    <div className="w-full flex flex-col items-center animate-in fade-in zoom-in duration-1000 px-6 font-headline">
      <div className="relative mb-12 flex items-center justify-center">
        ...
        <div className="relative w-24 h-24 bg-black border-2 border-primary/30 rounded-full flex items-center justify-center shadow-2xl">
      ...
      <h2 className="font-headline text-4xl font-black uppercase mb-12 text-center text-white tracking-tighter leading-none">
        DEVICE ALIGNED, <br/>
        <span className="text-[#10B981]">{data.name || 'USER'}</span>!
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mb-12 max-w-2xl">
        {[
          ...
          <div key={item.label} className="bg-[#0a0a0a] border-2 border-white/10 rounded-[2rem] p-8 flex flex-col items-center gap-4 group hover:border-primary transition-all">
      ...
      <Link href="/dashboard" className="w-full max-w-sm">
        <button className="pill-button w-full bg-[#1b4d3e] text-white text-lg font-black uppercase tracking-widest neon-glow active:scale-95 transition-all">
          ACCESS DASHBOARD
        </button>
      </Link>
    </div>
