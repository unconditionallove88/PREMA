  ...
  return (
    <div className="w-full flex flex-col items-center animate-in fade-in zoom-in duration-1000 min-h-[70vh] justify-center font-headline px-6">
      ...
      <div className="relative mb-16 flex items-center justify-center">
        <div className="absolute inset-0 bg-[#3EB489]/10 blur-[100px] rounded-full" />
        ...
        {/* Central Core */}
        <div className="relative w-32 h-32 bg-[#0a0a0a] rounded-full border-4 border-primary/40 flex items-center justify-center shadow-[0_0_50px_rgba(27,77,62,0.3)]">
          <Heart size={64} fill="#10B981" className="text-primary animate-pulse-heart" style={{ filter: 'drop-shadow(0 0 15px #10B981)' }} />
      ...
      <div className="text-center mb-16 space-y-4">
        <h2 className="font-headline text-5xl md:text-7xl font-black uppercase tracking-tighter leading-none text-white">
          {t.header} <br/>
          <span className="text-[#3EB489] drop-shadow-[0_0_20px_rgba(62,180,137,0.4)]">{name}</span>!
        </h2>
      ...
      <button 
        onClick={onComplete} 
        className="pill-button w-full max-w-md bg-[#1b4d3e] text-white text-2xl py-10 neon-glow font-headline font-black uppercase tracking-[0.2em] hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-4"
      >
